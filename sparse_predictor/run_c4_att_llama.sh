#!/bin/bash
# ==============================================================================
# Train Attention Sparse Predictor for Llama 3.2 3B - All Layers
# ==============================================================================
#
...
#   2. Verify data exists in: ../Decentralized_FM_alpha/data/llama_3b_c4/
#
# Usage:
#   ./run_c4_att_llama.sh
#
...
echo "======================================"
echo "Training Attention Sparse Predictor for Llama 3.2 3B"
