#!/bin/bash
# ==============================================================================
# WikiText Sparse Perplexity Evaluation - Llama 3.2 3B
# ==============================================================================

# Paths
input_file=./wikitext_eval/wikitext_test.jsonl
output_file=./wikitext_eval/output_llama_3b_sparse.jsonl
eval_file=./wikitext_eval/eval_llama_3b_sparse.txt
model_path=./pretrained_models/llama-3.2-3b
sparse_path=../checkpoint/llama-3b-sparse-predictor
...
echo "  MLP TopK: 2458 (30% kept = 70% sparsity)"
...
if logprobs:
    ...
    print(f'WikiText Sparse Perplexity (Llama 3.2 3B): {ppl:.4f}')
